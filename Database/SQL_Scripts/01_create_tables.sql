...
(
	...
	CONSTRAINT FK_Location_LocationType
		FOREIGN KEY
            (locationTypeId) REFERENCES LocationType
            (id)
		ON
            DELETE RESTRICT
		ON
...
    CONSTRAINT FK_AreaUser_User FOREIGN KEY
	...
	CONSTRAINT FK_Event_Location
		FOREIGN KEY
                    (locationId) REFERENCES Location
                    (id)
		ON
                    DELETE CASCADE
		ON
    ...
    CONSTRAINT FK_Event_Urgency
		FOREIGN KEY
                    (changedUrgency) REFERENCES UrgencyType
                    (id)
		ON
                    DELETE RESTRICT
		ON
